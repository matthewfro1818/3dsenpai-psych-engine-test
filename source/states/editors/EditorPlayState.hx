...
class EditorPlayState extends MusicBeatSubstate
{
	...
	function generateSong(dataPath:String)
	{
		...
		for (section in songData.notes) { for (i in 0...section.sectionNotes.length) {
				...
				if(!Std.isOfType(songNotes[3], String)) leNoteData.type = ChartingState.noteTypeList[songNotes[3]]; //Backwards compatibility + compatibility with Week 7 charts
